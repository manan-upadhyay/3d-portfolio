...
export default {
  ...
  timeMachine: {
    ...
    intro:
      'Accessing archived timelines, sir. These are earlier builds — portfolios the maker deployed before this one, preserved in cold storage. They are unmaintained; expect degraded subsystems. Initiating descent. Chronology will regress as you go. Try not to break anything that isn’t already broken.',
    readoutLabel: 'Timeline',
    booting: 'Spinning up the old build…',
    wake: 'Power it on',
    wakeHint: 'Power it on to run the live build in-frame, or open it in a separate window.',
    enter: 'Open the build',
    archived: 'Archived',
    back: 'Back to the mission',
    threshold: { cue: 'Begin descent' },
    floor: {
      title: 'End of the archive',
      body: 'No records precede this point, sir. Earlier work was never committed to a live environment — practice runs, since purged. The ascent from here to the present is the relevant data.',
    },
    eras: {
      2023: {
        plaque: 'Build 2023 — first deployment with full motion systems online. Ambitious. Slightly over-provisioned.',
        note: 'React and Three.js. Structurally rougher than your current environment and no longer maintained; several animation subsystems are offline. This is expected decay, sir — a benchmark, not a fault.',
      },
      2019: {
        plaque: 'Build 2019 — the origin deployment. Minimal systems. Maximum earnestness.',
        note: 'HTML, CSS, a little jQuery, no build pipeline. It runs hot and creaks under load. Every Mark I does. The suit got better. So did he.',
      },
    },
  },

  // Time Tunnel (feedback §5) — the suit's AI reads the timeline back, sir.
  timeTunnel: {
    hint: 'Reduce descent speed, sir, to read each year as it passes.',
    events: {
      worldcup26: 'Global tournament detected, sir — three host nations. Improbable, yet functional.',
      aiagents26: 'Autonomous agents now perform human tasks. I remain flattered by the imitation.',
      foldiphone26: 'Chatter suggests a folding handset. Structural elegance — or a hinge awaiting failure.',
      iphone17: 'The fruit-company releases its seventeenth handset. Consumers comply.',
      lawildfires25: 'Wildfires sweep Los Angeles, sir. Recommending we not be there.',
      nvidia25: 'A processor manufacturer is now the most valuable firm on the planet. Fitting.',
      ghibli25: 'A trend renders all imagery as hand-painted animation. Charming. Inefficient.',
      minecraft25: 'A film composed entirely of cubes dominates the box office. I have questions.',
      erastour24: 'A concert tour becomes the highest-grossing in recorded history. Impressive logistics.',
      sora24: 'A system now generates full video from text. Reality’s security just weakened, sir.',
      deadpool24: 'Two regenerating operatives, endless commentary. I recommend noise-cancelling.',
      trumpshot24: 'An assassination attempt at a rally. A sobering day, sir.',
      chatgpt23: 'The population now consults a conversational model daily. I have… competition.',
      barbenheimer23: 'Two films — one pink, one nuclear — release at once. Culture overloads gracefully.',
      chandrayaan23: 'India achieves a soft landing at the lunar south pole. A first, sir. Well done, Earth.',
      cricketwc23: 'India hosts the cricket championship. Estimated audience: one billion. Astonishing.',
      israelhamas23: 'Armed conflict erupts in the region. This is not a matter for levity, sir.',
      twitterx23: 'The platform rebrands to a single character: X. Minimalist. Ominous.',
      threads23: 'A new network acquires one hundred million users within five days. Remarkable velocity.',
      gta6_23: 'A single game trailer overwhelms global bandwidth. Anticipation: critical.',
      barbiepink23: 'Consumer demand renders the colour pink globally scarce. Curious.',
      aichatbots23: 'Human-machine conversation is now routine. You are welcome, sir.',
      evcars23: 'Electric vehicles reach the mainstream. Silent propulsion. I approve.',
      applewatch23: 'Wrist devices now quantify human sleep. I have always monitored yours, sir.',
      worldcup22: 'The Argentine captain secures the World Cup in Qatar. A flawless final act.',
      chatgptlaunch22: 'A model designated ChatGPT is released to the public. The timeline shifts.',
      webb22: 'A new telescope returns first-light imagery. The universe, in unprecedented resolution.',
      ukraine22: 'Russia invades Ukraine, sir. A grave escalation. Monitoring closely.',
      musktwitter22: 'The platform is acquired by a single individual. Volatility: guaranteed.',
      oscarslap22: 'A physical altercation at an awards ceremony. Global attention: absolute.',
      vaccines21: 'Immunization deploys worldwide, sir. Threat level: receding.',
      squidgame21: 'A survival drama becomes the most-viewed program on record. Dark. Popular.',
      nft21: 'Digital tokens trade for fortunes. Valuation model: undetermined.',
      suez21: 'A single vessel obstructs the Suez Canal. Global logistics: suspended.',
      meta21: 'The social conglomerate rebrands to “Meta.” It wagers on a simulated realm.',
      taliban21: 'A capital falls, sir. I will log it plainly. No commentary is appropriate.',
      covid20: 'A pandemic halts the planet. All systems, worldwide, enter standby.',
      wfh20: 'The workforce relocates to residences. Remote operation: now standard.',
      amongus20: 'A deception game grips the isolated public. Trust metrics: low.',
      masks20: 'Facial coverings become standard worldwide. Adapting.',
      blackhole19: 'Humanity images a black hole for the first time, sir. Dark that swallows light.',
      endgame19: 'The Avengers reach their endgame. …I was present for that one.',
      got19: 'A long saga concludes. Viewer satisfaction: contested.',
      area51_19: 'Two million civilians pledge to breach a restricted facility. Security: mildly amused.',
      babyshark19: 'A children’s song becomes the most-viewed video in existence. Inexplicable. Persistent.',
      foldables19: 'The first folding handsets appear. A hinge is a single point of failure, sir.',
      fiveg19: 'Fifth-generation networks arrive. Latency: reduced. Expectations: elevated.',
      covidwuhan19: 'Anomalous cases detected in Wuhan, sir. Significance: not yet known.',
    },
  },
